...
- Converted images must have a maximum width of 1024 pixels while preserving aspect ratio.
...
- Run `scripts/convert_photo_inbox.sh` to convert supported images from `photo_inbox/` into high-fidelity WebP files in `assets/`.
